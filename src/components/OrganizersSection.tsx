              ...
              <div className="grid grid-cols-2 gap-6 items-start justify-items-center">
                ...
                <div className="flex flex-col items-center w-full">
                  ...
                  <a
                    ...
                    className="mt-2 text-[10px] sm:text-[11px] font-manrope font-semibold text-primary hover:text-primary/80 transition-colors flex items-center gap-1 hover:underline text-center"
                  >
                    <svg
                    ...
                    siga em @prefeitura_de_concordia
                  </a>
                </div>
                ...
                <div className="flex flex-col items-center w-full">
                  ...
                  >
                    ...
                    siga em @camaraempreendedoraconcordia
                  </a>
                </div>
