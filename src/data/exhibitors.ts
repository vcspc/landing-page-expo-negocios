export interface Exhibitor {
  id: string;
  name: string;
  category: 'Alimentação' | 'Modas e Acessórios' | 'Móveis e Eletro' | 'Tecnologia e Serviços' | 'Automóveis' | 'Artesanato e Cultura' | 'Beleza e Bem-estar' | 'Agricultura Familiar';
  categoryKey: 'alimentacao' | 'modas' | 'moveis' | 'tecnologia' | 'automoveis' | 'artesanato' | 'beleza' | 'agricultura';
  description: string;
  logoUrl?: string;
  phone: string;
  links: {
    ...
    facebook?: string;
    email?: string;
    extraAction?: 'share' | 'shopping_bag' | 'rocket_launch' | 'order' | 'info';
  };
  notes?: string;
}
...
export const EXHIBITORS: Exhibitor[] = [
  ...
  },
  {
    id: 'norte-digital',
    name: 'Norte Digital',
    category: 'Tecnologia e Serviços',
